  ...
  <div class="box">
		...
		<div class="box-body">
			<div >
				...
				<a href='<?php echo url('index.php?mn=rekap-total-range') ?>' class='btn btn-success'><i class='fa fa-'></i> REKAP KARYAWAN  </a>
			...
			<div>
				...
				<form method=get>
					<input type=hidden value='rekap_satpam' name='mn'/>
				...
				Total Hari 		: <?php echo $jumlah_hari?>
					...
					<table border=1 class=' table- table-hover' style='width:100%'>
						...
						and karyawan.id_jabatan=jabatan.id_jabatan  and departemen.kode_departemen='09' order by karyawan.id_jabatan,karyawan.tgl_masuk ";
						...
						while($Kar=mysql_fetch_array($query))
						{
							...
							and id_karyawan=$idkaryawan and (keterangan_hadir='lembur'  )
							...
							$lembur_hari=hitung_ket_karyawan_range($idkaryawan,'lembur',$tgl_baru,$tglakhir) ;
							...
							//pulang/SETENGAH HARI
								...
								*/
								...
								$libur=count($hitung_lbr) + ($lembur_libur / 2) + $off ;
							...
							<tr >
								...
								<td><?php echo 0;//total_lembur_range($idkaryawan,$tgl_baru,$tglakhir) ?></td>
								<td><?php echo $lembur_hari = $lembur_hari - ($lembur_izin / 2) - ($lembur_libur / 2)   ?> </td>
								...
								<td><?php echo $total_kerja - $tm - ($ppp / 2) + $masuk_setengah_hari  ?></td>
